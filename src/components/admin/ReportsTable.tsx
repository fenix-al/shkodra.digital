...
import { AlertTriangle, CheckCircle2, Clock, Eye, MapPin, Image as ImageIcon, ChevronDown, X, ExternalLink } from 'lucide-react'
...
const NEXT_STATUSES: Partial<Record<ReportStatus, { value: ReportStatus; label: string; className: string }[]>> = {
  hapur: [
    { value: 'në_shqyrtim', label: 'Merr në shqyrtim', className: 'text-amber-400 hover:bg-amber-500/10' },
